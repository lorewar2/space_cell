...
def train_gaston():
    ...
    # coordinates
    spatial_df = pd.read_csv(COOR_FILE, usecols=[0, 4, 5])
...
def plot_iso_depth():
    ...
    plt.savefig("clusters_gaston_slide.png", dpi=300, bbox_inches="tight")
    plt.close()
    ...
    plt.savefig("clusters_gaston_slide2.png", dpi=300, bbox_inches="tight")
    plt.close()
    return
